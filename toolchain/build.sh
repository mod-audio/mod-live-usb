...
# x86_64 here refers to the host system, meaning we are running this script on a x86_64 machine
...
docker run -v ${WORKDIR}:/home/builder/mod-workdir --rm mpb-toolchain-x86_64:latest ./bootstrap.sh raspberrypi4 toolchain
...
rm -rf ${WORKDIR}/raspberrypi4/build/crosstool-ng-1.24.0
mkdir ${WORKDIR}/raspberrypi4/build/crosstool-ng-1.24.0
touch ${WORKDIR}/raspberrypi4/build/crosstool-ng-1.24.0/.stamp_configured
touch ${WORKDIR}/raspberrypi4/build/crosstool-ng-1.24.0/.stamp_built1
touch ${WORKDIR}/raspberrypi4/build/crosstool-ng-1.24.0/.stamp_built2
touch ${WORKDIR}/raspberrypi4/build/crosstool-ng-1.24.0/configure
